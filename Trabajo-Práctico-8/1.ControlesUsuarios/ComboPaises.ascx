<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ComboPaises.ascx.cs" Inherits="ComboPaises" %>
<asp:DropDownList ID="cbx" runat="server">
    <asp:ListItem Value="Argentina" Text="Argentina"></asp:ListItem>
    <asp:ListItem Value="Brasil" Text="Brasil"></asp:ListItem>
